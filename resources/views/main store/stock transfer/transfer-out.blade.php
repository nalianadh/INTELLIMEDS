        ...
        <div style="background: #f8f9fa; padding: 16px 24px; border-radius: 12px; margin-bottom: 24px; border: 1px solid #e9ecef;">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="tr_from_unit" id="tr_from_unit" placeholder="Enter source unit" required>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" name="tr_destination" id="tr_destination" placeholder="Enter destination unit" required>
                </div>
            </div>
        </div>
